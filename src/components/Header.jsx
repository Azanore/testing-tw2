        ...
        <div className="px-5 py-4 md:px-8 lg:px-12">
          <div className="flex items-center justify-between max-w-7xl mx-auto">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <a href="#" className="text-wire-text-secondary">Features</a>
              <a href="#" className="text-wire-text-secondary">Pricing</a>
              <a href="#" className="text-wire-text-secondary">Demo</a>
              <a href="#" className="text-wire-text-secondary">Docs</a>
            </nav>

            {/* CTA Buttons */}
            <div className="flex items-center space-x-4">
              <button className="hidden sm:block text-wire-text-secondary">
                Sign In
              </button>
              <button className="bg-wire-accent text-white px-5 py-2 rounded-lg">
                Start Free Trial
              </button>
